/* Exemplo de uma classe que lança uma exceção RuntimeException.
*/
public class AlunoE {
  ...
  //-------------------------------------------------------
  // Construtor padrão (default): AlunoE()
  //-------------------------------------------------------
  public AlunoE() {
  ...
  //-------------------------------------------------------
  // Construtor: AlunoE(String)
  //-------------------------------------------------------
  public AlunoE(String n) {
    //Chama o construtor AlunoE(). Deve ser a primeira linha.
    this();     
  ...
  //-------------------------------------------------------
  // Construtor: AlunoE(String, char)
  //-------------------------------------------------------
  public AlunoE(String n, char s) {
    //Chama o construtor AlunoE(String). Deve ser a primeira linha.
    this(n);
    //Atribui o sexo.
    setSexo(s);    
  }
  ...
  //-------------------------------------------------------
  // Construtor: AlunoE(String, char, int)
  //-------------------------------------------------------
  public AlunoE(String n, char s, int i) {
    //Chama o construtor AlunoE(String, char). Deve ser a primeira linha.
    this(n, s);
    //Atribui a idade.    
    setIdade(i);
  }
  ...
  //-------------------------------------------------------
  // Construtor: AlunoE(String, char, int, float, float)
  ...
  //-------------------------------------------------------
  public AlunoE(String n, char s, int i, float n1, float n2) {
    //Lembre que: 
  ...
  public void setNome(String nome) {
    if (nome.length() > 0 ) {
      ...
      throw new RuntimeException("Erro: nome vazio.");
  }
  ...
  public void setSexo(char sexo) {
    if ((sexo==MASCULINO) || (sexo==FEMININO)) {
      ...
      throw new RuntimeException("Erro: sexo invalido (" + sexo +")");
  }
  ...
  public void setIdade(int idade) {
    if (idade >= 0 ) {
      ...
      throw new RuntimeException("Erro: idade menor ou igual a zero (" + idade +")");
  }
  ...
  public void setNota1(float nota1) {
    if ((nota1 >= notaMinima) && (nota1 <= notaMaxima)) {
      ...
      throw new RuntimeException("Erro: nota inválida (" + nota1 +")");
  }
  ...
  public void setNota2(float nota2) {
    if ((nota2 >= notaMinima) && (nota2 <= notaMaxima)) {
      ...
      throw new RuntimeException("Erro: nota inválida (" + nota2 +")");
  }
